    ...
    public function getViewHelperConfig()
    {
        return array(
            'factories' => array(
                ...
                'zfcUserId' => function ($sm) {
                	$locator = $sm->getServiceLocator();
                	$viewHelper = new View\Helper\ZfcUserId;
                	$viewHelper->setAuthService($locator->get('zfcuser_auth_service'));
                	return $viewHelper;
                },
    ...
    public function getServiceConfig()
    {
        return array(
            ...
            'factories' => array(
                ...
                'zfcuser_change_displayname_form' => function($sm) {
                	$options = $sm->get('zfcuser_module_options');
                	$form = new Form\ChangeDisplayName(null, $sm->get('zfcuser_module_options'));
                	$form->setInputFilter(new Form\ChangeDisplayNameFilter($options));
                	return $form;
                },
